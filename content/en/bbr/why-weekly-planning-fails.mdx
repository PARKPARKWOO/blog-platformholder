...
## The one problem BBR solves

BBR (Barbell Robot) tackles a single thing:
...
> [The 5-minute guide to your first BBR weekly plan](/en/blog/bbr/create-weekly-pt-plan) walks through the actual flow.
